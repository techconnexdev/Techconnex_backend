// src/modules/provider/milestones/controller.js
...
export async function getProjectMilestonesController(req, res) {
  try {
    ...
    const result = await getProjectMilestones(projectId, providerId)
...
export async function updateProjectMilestonesController(req, res) {
  try {
    ...
    const result = await updateProjectMilestones(projectId, providerId, milestones)
...
export async function approveMilestonesController(req, res) {
  try {
    ...
    const result = await approveMilestones(projectId, providerId)
