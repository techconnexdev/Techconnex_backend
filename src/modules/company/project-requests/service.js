        ...
        include: {
          ...
          serviceRequest: {
            select: {
              ...
              currencyCode: true,
              fxSnapshotDate: true,
              fxSnapshotSession: true,
              fxSnapshotQuote: true,
    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      const project = await tx.project.create({
        data: {
          ...
          fxSnapshotDate: proposal.serviceRequest.fxSnapshotDate || null,
          fxSnapshotSession: proposal.serviceRequest.fxSnapshotSession || null,
          fxSnapshotQuote: proposal.serviceRequest.fxSnapshotQuote || null,
          fxSnapshotRatesJson: proposal.serviceRequest.fxSnapshotRatesJson || null,
